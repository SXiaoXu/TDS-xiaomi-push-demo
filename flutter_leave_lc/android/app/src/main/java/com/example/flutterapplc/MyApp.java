...
public class MyApp extends FlutterApplication {
    private static final String LC_APP_ID = "HoiGvMeacbPWnv12MK";
    private static final String LC_APP_KEY = "FesqQUmlhjMWt6uNrKaV6QPtYgBYZMP9QFmTUk54";
    private static final String LC_SERVER_URL = "https://hoigvmea.cloud.tds1.tapapis.cn";
    @Override
